...
{:else}
  <div class="text-center">
      ...
      <a href="/popular"
         class="px-[1.2rem] text-gray-700 h-full mx-auto mt-8 py-[.6rem] w-max md:flex items-center gap-[1rem] duration-200 hover:bg-[rgba(0,0,0,.01)] rounded-[.8rem] border-[.1rem] border-gray-200">
