...
import ColorPreviewAndCopy from '@/components/ColorPreviewAndCopy.vue'
import { ref } from 'vue'
...
<template>
  <div class="card-base flex flex-col aspect-square w-full">
    <div
    ...
    >
      <ColorPreviewAndCopy v-for="color in props.colors" v-bind:key="color" :color="color" />
    </div>
    <div class="flex-center w-full gap-3 mt-5">
      <LikeBtn :clicked="activated" :colors="props.colors" />
      <DowloadPaletteBtn :colors="props.colors" />
    </div>
  </div>
</template>
